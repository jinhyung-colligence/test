...
const translations = {
  ko: {
    // Header
    'header.title': 'Custody Dashboard',
    ...
    'selector.subtitle': 'MPC 기반 보안 강화와 Off-chain UI를 통한 차세대 디지털 자산 커스터디 플랫폼',
    ...
    'users.not_available': '이 기능은 프리미엄 또는 기업용 플랜에서 사용할 수 있습니다.',
  ...
  en: {
    ...
    'overview.price_trend': 'Asset Value Trend',
    ...
    'selector.subtitle': 'Next-generation digital asset custody platform with MPC-based security enhancement and Off-chain UI',
    ...
    'users.subtitle': 'RBAC-based permission management and multi-approval settings',
    ...
    'users.not_available': 'This feature is available in Premium or Enterprise plans.',
    ...
    'approval.new_address': 'Require admin approval for new address withdrawals',
