    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">연결된 은행 계좌</h3>
          <a
            href="/security"
          ...
          <div className="border border-primary-200 bg-primary-50 rounded-lg p-4 cursor-pointer hover:bg-primary-100 transition-colors">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 font-mono">***-***-123456</div>
                <div className="text-xs text-gray-500">일일 한도: ₩5,000,000</div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="px-2 py-1 text-xs bg-gray-100 text-gray-600 rounded">대기</span>
                </div>
                <div className="text-sm text-gray-600 font-mono">***-***-789012</div>
                <div className="text-xs text-gray-500">일일 한도: ₩3,000,000</div>
              </div>
            </div>
          </div>
        </div>
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-start space-x-2">
            ...
            <p className="text-sm text-blue-800">
              원화 교환을 위해서는 연결된 은행 계좌가 필요합니다.
              <a href="/security" className="underline hover:no-underline">보안 설정</a>에서 계좌를 연결하세요.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            ...
            <button className="w-full py-3 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed" disabled>
              암호화폐 판매
            </button>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            ...
            <button className="w-full py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed" disabled>
              암호화폐 구매
            </button>
            <p className="text-xs text-center text-gray-500 mt-2">
              계좌 연결 후 이용 가능합니다
