...
export const mockGroups: WalletGroup[] = [
  {
    ...
    balance: { amount: 1675000, currency: 'KRW' },
    monthlyBudget: { amount: 2010000, currency: 'KRW' },
    quarterlyBudget: { amount: 0, currency: 'KRW' },
    yearlyBudget: { amount: 0, currency: 'KRW' },
    budgetUsed: { amount: 335000, currency: 'KRW' },
    quarterlyBudgetUsed: { amount: 0, currency: 'KRW' },
    yearlyBudgetUsed: { amount: 0, currency: 'KRW' },
    budgetSetup: {
      year: 2025,
      baseType: 'monthly',
      baseAmount: 2010000,
      ...
      selectedMonth: 9,
      quarterlyBudgets: [],
      monthlyBudgets: [{ month: 9, amount: 2010000 }],
  ...
  },
  {
    ...
    balance: { amount: 48.5, currency: 'KRW' },
    monthlyBudget: { amount: 25.0, currency: 'KRW' },
    quarterlyBudget: { amount: 80.0, currency: 'KRW' },
    yearlyBudget: { amount: 0, currency: 'KRW' },
    budgetUsed: { amount: 18.2, currency: 'KRW' },
    quarterlyBudgetUsed: { amount: 32.5, currency: 'KRW' },
    yearlyBudgetUsed: { amount: 0, currency: 'KRW' },
    budgetSetup: {
      year: 2025,
      baseType: 'quarterly',
  ...
  },
  {
    ...
    balance: { amount: 2.15, currency: 'KRW' },
    monthlyBudget: { amount: 1.8, currency: 'KRW' },
    quarterlyBudget: { amount: 5.5, currency: 'KRW' },
    yearlyBudget: { amount: 22.0, currency: 'KRW' },
    budgetUsed: { amount: 1.2, currency: 'KRW' },
    quarterlyBudgetUsed: { amount: 3.1, currency: 'KRW' },
    yearlyBudgetUsed: { amount: 8.7, currency: 'KRW' },
    budgetSetup: {
      year: 2025,
      baseType: 'yearly',
      baseAmount: 20.0,
  ...
  },
  {
    ...
    balance: { amount: 850, currency: 'KRW' },
    monthlyBudget: { amount: 120, currency: 'KRW' },
    quarterlyBudget: { amount: 400, currency: 'KRW' },
    yearlyBudget: { amount: 1600, currency: 'KRW' },
    budgetUsed: { amount: 95, currency: 'KRW' },
    quarterlyBudgetUsed: { amount: 285, currency: 'KRW' },
    yearlyBudgetUsed: { amount: 920, currency: 'KRW' },
    budgetSetup: {
      year: 2025,
      baseType: 'yearly',
      baseAmount: 1400,
...
export const mockExpenses: ExpenseRequest[] = [
  // === 2025년 1월 (이번 달) ===
  {
    ...
    groupId: "1",
    title: "1월 소셜미디어 광고비",
    amount: { amount: 180, currency: 'KRW' },
  ...
  },
  {
    ...
    amount: { amount: 5.2, currency: 'KRW' },
  ...
  },
  {
    ...
    groupId: "3",
    title: "1월 AWS 인프라 비용",
    amount: { amount: 0.8, currency: 'KRW' },
  ...
  // === 2024년 12월 (작년) ===
  {
    ...
    groupId: "1",
    title: "연말 브랜드 캠페인",
    amount: { amount: 320, currency: 'KRW' },
  ...
  },
  {
    ...
    groupId: "2",
    title: "연말 UI/UX 개선",
    amount: { amount: 8.5, currency: 'KRW' },
  ...
  },
  {
    ...
    groupId: "4",
    title: "연말 DeFi 연구 자료",
    amount: { amount: 120, currency: 'KRW' },
  ...
  // === 2024년 11월 ===
  {
    ...
    groupId: "3",
    title: "보안 시스템 강화",
    amount: { amount: 1.5, currency: 'KRW' },
  ...
  },
  {
    ...
    groupId: "1",
    title: "11월 콘텐츠 제작비",
    amount: { amount: 200, currency: 'KRW' },
  ...
  },
  {
    ...
    groupId: "2",
    title: "10월 개발 환경 구축",
    amount: { amount: 6.8, currency: 'KRW' },
  ...
  // === 2024년 9월 ===
  {
    ...
    groupId: "3",
    title: "9월 클라우드 확장",
    amount: { amount: 0.9, currency: 'KRW' },
  ...
  },
  {
    ...
    groupId: "1",
    title: "9월 광고 캠페인",
    amount: { amount: 280, currency: 'KRW' },
...
export const mockGroupRequests: GroupCreationRequest[] = [
  {
    ...
    monthlyBudget: { amount: 2000, currency: 'KRW' },
    quarterlyBudget: { amount: 6000, currency: 'KRW' },
    yearlyBudget: { amount: 24000, currency: 'KRW' },
    budgetSetup: {
      year: 2025,
      baseType: 'yearly',
      baseAmount: 24000,
  ...
  },
  {
    ...
    monthlyBudget: { amount: 5.0, currency: 'KRW' },
    quarterlyBudget: { amount: 15.0, currency: 'KRW' },
    yearlyBudget: { amount: 60.0, currency: 'KRW' },
    budgetSetup: {
      year: 2025,
      baseType: 'quarterly',
      baseAmount: 15.0,
  ...
  },
  {
    ...
    monthlyBudget: { amount: 1.2, currency: 'KRW' },
    quarterlyBudget: { amount: 3.6, currency: 'KRW' },
    yearlyBudget: { amount: 14.4, currency: 'KRW' },
    manager: "윤보안",
    status: "rejected",
    requestedBy: "윤보안",
  ...
  },
  {
    ...
    monthlyBudget: { amount: 800, currency: 'KRW' },
    quarterlyBudget: { amount: 2400, currency: 'KRW' },
    yearlyBudget: { amount: 9600, currency: 'KRW' },
    budgetSetup: {
      year: 2025,
      baseType: 'monthly',
      baseAmount: 800,
  ...
  },
  {
    ...
    monthlyBudget: { amount: 3.0, currency: 'KRW' },
    quarterlyBudget: { amount: 9.0, currency: 'KRW' },
    yearlyBudget: { amount: 36.0, currency: 'KRW' },
    manager: "임블록",
    status: "archived",
    requestedBy: "임블록",
